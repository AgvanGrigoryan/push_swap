...
/*   Updated: 2024/02/25 17:28:00 by aggrigor         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	init_stack_a(t_stack **stack_a, t_list *dummy)
{
...
int	process_sub_args(char *arg, t_list *dummy, t_stack *stack, int *total_index)
{
	...
	if (sub_args == NULL || (arg && arg[0] != '\0' && sub_args[0] == NULL))
		return (0);
	while (sub_args[i])
	{
