...
/*   Updated: 2024/02/26 22:27:02 by aggrigor         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
{
	if (action[1] == 'a' && action[2] == '\n' && action[3] == '\0')
		sa(stack_a, DONT_PRINT_ACTION);
	else if (action[1] == 'b' && action[2] == '\n' && action[3] == '\0')
		sb(stack_b, DONT_PRINT_ACTION);
	else if (action[1] == 's' && action[2] == '\n' && action[3] == '\0')
		ss(stack_a, stack_b, DONT_PRINT_ACTION);
	else
		return (-1);
	return (1);
}
